...
## Project Structure
    ...
    ├── stinson_cna_test_pr_35334  # Django project configurations
...
1. Clone this repo and `cd stinson_cna_test_pr_35334`
...
2. Clone this repo and `cd stinson_cna_test_pr_35334`
